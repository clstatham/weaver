...
pub async fn extract_bsps(
    ...
    mut bsp_assets: Extract<ResMut<Assets<Bsp>>>,
    mut source_meshes: Extract<ResMut<Assets<Mesh>>>,
    mut source_shaders: Extract<ResMut<Assets<LoadedShader>>>,
    mut source_textures: Extract<ResMut<Assets<Texture>>>,
